<!DOCTYPE html>
<!-- saved from url=(0028)https://www.ameliehaeck.com/ -->
<html data-wf-domain="www.ameliehaeck.com" data-wf-page="636d31afbd19aa93e23b02d0" data-wf-site="636d31afbd19aa510b3b02cc" class=" w-mod-js w-mod-ix" data-lt-installed="true">
  <head>
    ...
    <link href="{{asset('webstyle\ameliehaeck03.webflow.d3a04e498.css')}}" rel="stylesheet" type="text/css"><!--[if lt IE 9]><script src="https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.min.js" type="text/javascript"></script><![endif]-->
  ...
  <div class="thumbnail-list-wrapper demo w-dyn-list">
    <div role="list" class="collection-list w-dyn-items">
      <div role="listitem" class="collection-item w-dyn-item">
        ...
        @else
          <div class="demoreel-container">
            <a data-w-id="4eec0963-02d5-4ae5-5bed-23fa7024cc03" href="https://www.ameliehaeck.com/videos/demo" class="video-thumbnail is-small demo-thumbnail w-inline-block">
              <div class="html-embed-3 w-embed">
