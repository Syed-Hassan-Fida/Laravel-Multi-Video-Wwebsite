        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-hover">
                        <h3>Home Single Video (Preview) Info</h3>
                        <thead>
                          <tr>
                            <th scope="col">#</th>
                            <th scope="col">Title</th>
                            ...
                            @if(sizeof($homeSingleVideos) > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('home-single-video-delete', ['id'=>$homeSingleVideo->id]) }}" style="color: red; text-decoration: none;">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            @else
